				...
				<tr>
					...
					<td class="td-login">
						<select name="barangay">
							...
							<option>Alapan I-A</option>
							<option>Alapan I-B</option>
							<option>Alapan I-C</option>
							<option>Alapan II-A</option>
							<option>Alapan II-B</option>
							<option>Anabu I-A</option>
							<option>Anabu I-B</option>
							<option>Anabu I-C</option>
							<option>Anabu I-D</option>
							<option>Anabu I-E</option>
							<option>Anabu I-F</option>
							<option>Anabu I-G</option>
							<option>Anabu II-A</option>
							<option>Anabu II-B</option>
							<option>Anabu II-C</option>
							<option>Anabu II-D</option>
							<option>Anabu II-E</option>
							<option>Anabu II-F</option>
							<option>Bagong Silang</option>
							<option>Bayan Luma I</option>
							<option>Bayan Luma II</option>
							<option>Bayan Luma III</option>
							<option>Bayan Luma IV</option>
							<option>Bayan Luma V</option>
							<option>Bayan Luma VI</option>
							<option>Bayan Luma VII</option>
							<option>Bayan Luma VIII</option>
							<option>Bayan Luma IX</option>
							<option>Bucandala I</option>
							<option>Bucandala II</option>
							<option>Bucandala III</option>
							<option>Bucandala IV</option>
							<option>Bucandala V</option>
							<option>Buhay Na Tubig</option>
							<option>Carsadang Bago I</option>
							<option>Carsadang Bago II</option>
							<option>Magdalo</option>
							<option>Maharlika</option>
							<option>Malagasang I-A</option>
							<option>Malagasang I-B</option>
							<option>Malagasang I-C</option>
							<option>Malagasang I-D</option>
							<option>Malagasang I-E</option>
							<option>Malagasang I-F</option>
							<option>Malagasang I-G</option>
							<option>Malagasang II-A</option>
							<option>Malagasang II-B</option>
							<option>Malagasang II-C</option>
							<option>Malagasang II-D</option>
							<option>Malagasang II-E</option>
							<option>Malagasang II-F</option>
							<option>Malagasang II-G</option>
							<option>Mariano Espeleta I</option>
							<option>Mariano Espeleta II</option>
							<option>Mariano Espeleta III</option>
							<option>Medicion I-A</option>
							<option>Medicion I-B</option>
							<option>Medicion I-C</option>
							<option>Medicion I-D</option>
							<option>Medicion II-A</option>
							<option>Medicion II-B</option>
							<option>Medicion II-C</option>
							<option>Medicion II-D</option>
							<option>Medicion II-E</option>
							<option>Medicion II-F</option>
							<option>Pag-Asa I</option>
							<option>Pag-Asa II</option>
							<option>Pag-Asa III</option>
							<option>Palico I</option>
							<option>Palico II</option>
							<option>Palico III</option>
							<option>Palico IV</option>
							<option>Pasong Buaya I</option>
							<option>Pasong Buaya II</option>
							<option>Pinagbuklod</option>
							<option>Poblacion I-A</option>
							<option>Poblacion I-B</option>
							<option>Poblacion I-C</option>
							<option>Poblacion II-A</option>
							<option>Poblacion II-B</option>
							<option>Poblacion III-A</option>
							<option>Poblacion III-B</option>
							<option>Poblacion IV-A</option>
							<option>Poblacion IV-B</option>
							<option>Poblacion IV-C</option>
							<option>Poblacion IV-D</option>
							<option>Tanzang Luma I</option>
							<option>Tanzang Luma II</option>
							<option>Tanzang Luma III</option>
							<option>Tanzang Luma IV</option>
							<option>Tanzang Luma V</option>
							<option>Tanzang Luma VI</option>
							<option>Toclong I-A</option>
							<option>Toclong I-B</option>
							<option>Toclong I-C</option>
							<option>Toclong II-A</option>
							<option>Toclong II-B</option>
					</select>
					</td>
				</tr>
				<tr>
