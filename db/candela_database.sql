...
(5, 'Blueberry Cake', 'images/product_5.jpeg', 'product5.php', '150.25', 7, 'a delectable olfactory and visual delight that captures the essence of a freshly baked blueberry cake. This artisanal candle is meticulously designed to replicate the irresistible charm of a blueberry-infused confection.\r\n\r\nThe Blueberry Bliss Cake Candle features a rich, deep-blue wax, reminiscent of plump, juicy blueberries. The candle is skillfully shaped to mirror the layers of a cake, with intricate details that add a touch of authenticity to the design. The blue hue adds a pop of color, making it a visually appealing and stylish addition to any room.');
